...
export default function Hero() {
  ...
  return (
    <section id="mainhero" className="relative flex flex-col justify-center items-center gap-10 w-full lg:mt-0 mt-[55px] lg:min-h-[60vh] min-h-[80vh] bg-[--navyblur]">
      ...
      <div className="container flex flex-col lg:flex-nowrap gap-10 justify-center items-center z-10 lg:w-1/3 w-11/12 lg:mb-0 mb-20 bg-[--navyblur] p-4 backdrop-blur-sm border border-[--lightnavy] rounded-lg">
        <h1 className="text-center">Kedves vendégeink</h1>
